function [lonout latout zout inode]=getgrid(lon,lat,z,azi,length,nsource,grid)
...
%  z_all=grid(14509:end);
%  cd /diego-local/Research/Data/Toki/denseGF
%  load('japan_north_grid.mat');
%  lon_all=grid(1:87516);
%  lat_all=grid(87517:175032);
%  z_all=grid(175033:end);
